!function(){var t="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},e={},o={},a=t.parcelRequired7c6;null==a&&((a=function(t){if(t in e)return e[t].exports;if(t in o){var a=o[t];delete o[t];var r={id:t,exports:{}};return e[t]=r,a.call(r.exports,r,r.exports),r.exports}var l=Error("Cannot find module '"+t+"'");throw l.code="MODULE_NOT_FOUND",l}).register=function(t,e){o[t]=e},t.parcelRequired7c6=a),a("8ERGB"),a("3qT3v"),a("i8Q71"),a("gVa74");var r=a("kK94C"),l=a("b3pWk");function i(t){let e=Math.round(t);return[,,,,,].fill(0).map((t,o)=>e-2*(o+1)>=0?'<div class="star"></div>':e-2*(o+1)+1==0?'<div class="star-half"></div>':'<div class="star-outline"></div>').join("")}let n=new r.default,s=document.querySelector(".weekly-gallery");s.addEventListener("click",function(t){console.log(t.target.getAttribute("film-id"),"Це id фільму")}),n.fetchTrendingWeekMovies().then(t=>{let e=t.data.results;console.log(e);let o=function(t){let e=[];for(let o=0;o<3;o++)e.push(Math.floor(Math.random()*t));return e}(e.length-1),a=[];o.forEach(t=>{let o=e[t];a.push(o)}),s.innerHTML=a.map(t=>(0,l.default)(t,i)).join(""),console.log(a)}).catch(t=>console.error(t));var r=a("kK94C"),c=a("lwvvG");a("eL2pK");let d=(t,e)=>{try{let o=JSON.stringify(e);localStorage.setItem(t,o)}catch(e){console.error(`Error saving ${t} to localStorage:`,e)}},p=t=>{try{let e=localStorage.getItem(t);return e?JSON.parse(e):void 0}catch(e){console.error(`Error loading ${t} from localStorage:`,e);return}},u=document.querySelector(".js-upcoming-wrapper"),g=new r.default;console.log(g),g.fetchUpcomingMovies().then(t=>{console.log("Upcoming",t);let e=t.data;console.log(e);let o={pageCurrent:e.page,totalResults:e.total_results,results:e.results};console.log(o);let a=o.results;if(a.length>0){(function(t){let e=Math.floor(15*Math.random()),o=t.filter(t=>null!==t.backdrop_path).map(t=>`
