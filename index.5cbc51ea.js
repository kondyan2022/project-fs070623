var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},t={},i={},r=e.parcelRequired7c6;null==r&&((r=function(e){if(e in t)return t[e].exports;if(e in i){var r=i[e];delete i[e];var l={id:e,exports:{}};return t[e]=l,r.call(l.exports,l,l.exports),l.exports}var n=Error("Cannot find module '"+e+"'");throw n.code="MODULE_NOT_FOUND",n}).register=function(e,t){i[e]=t},e.parcelRequired7c6=r),r("faBfA"),r("h5Hr7"),r("bUb57");var l=r("9MaFa");const n=new l.default,o=document.querySelector(".weekly-gallery");o.addEventListener("click",function(e){console.log(e.target.getAttribute("film-id"),"Це id фільму")}),n.fetchTrendingWeekMovies().then(e=>{let t=e.data.results;console.log(t);let i=function(e){let t=[];for(let i=0;i<3;i++)t.push(Math.floor(Math.random()*e));return t}(t.length-1),r=[];i.forEach(e=>{let i=t[e];r.push(i)}),o.innerHTML=r.map(e=>(function({id:e,title:t,poster_path:i,genre_ids:r,release_date:l,vote_average:n},o){let a=o(n);return`<div class="film-card" film-id="${e}">
  <img
    srcset="
