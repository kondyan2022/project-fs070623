var t="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},e={},a={},r=t.parcelRequired7c6;null==r&&((r=function(t){if(t in e)return e[t].exports;if(t in a){var r=a[t];delete a[t];var o={id:t,exports:{}};return e[t]=o,r.call(o.exports,o,o.exports),o.exports}var i=Error("Cannot find module '"+t+"'");throw i.code="MODULE_NOT_FOUND",i}).register=function(t,e){a[t]=e},t.parcelRequired7c6=r),r("faBfA"),r("h5Hr7"),r("bUb57"),r("aqXyV");var o=r("9MaFa"),i=r("7274P"),n=r("bEw54");r("I2Abx");var d=r("38Z3Q");const l=new o.default,s=document.querySelector(".weekly-gallery");s.addEventListener("click",function(t){let e=t.target.closest("[film-id]");e&&(0,d.openModalCard)(e.getAttribute("film-id"))}),l.fetchTrendingWeekMovies().then(t=>{let e=t.data.results,a=function(t){let e=[];for(;e.length<3;){let a=Math.floor(Math.random()*t);e.includes(a)||e.push(a)}return e}(e.length-1),r=[];a.forEach(t=>{let a=e[t];r.push(a)}),s.innerHTML=r.map(t=>(0,i.default)(t,n.default)).join("")}).catch(t=>console.error(t));var o=r("9MaFa"),c=r("b5rV1"),p=r("2rpgd");const u=document.querySelector(".js-upcoming-wrapper"),m=new o.default;(async function(){try{let t=await m.fetchUpcomingMovies(),e=t.data,a=e.results;if(a.length>0){let t=await function(t){let e=t.filter(t=>null!==t.backdrop_path).map(t=>{let e=`
                ...
                </div>`;return{id:t.id,markup:e}})[Math.floor(15*Math.random())];return e}(a),{id:e,markup:r}=t;u.innerHTML=r;let o=document.querySelector(".up-btn");(0,c.isInLibrary)(e)?o.textContent="Remove from my library":o.textContent="Add to my library",u.addEventListener("click",t=>{if(t.target===document.querySelector(".up-btn")){let e=t.target,r=t.target.dataset.movieId,o=a.find(t=>t.id==r);(0,c.isInLibrary)(r)?((0,c.removeFromLibrary)(r),e.textContent="Add to my library"):((0,c.saveToLibrary)(o),e.textContent="Remove from my library")}})}else 0===a.length&&(u.innerHTML='<p class="upcoming-error">OOPS... We are very sorry! Upcoming this month not found.</p>')}catch(t){console.error(t)}})(),r("38Z3Q"),r("I2Abx"),r("6fsAg"),r("epHO8");
//# sourceMappingURL=index.8d03b0ec.js.map
