...
=======
// const fetchTrendi = new TMDBApiService();
...
//   try {
//     const response = await fetch('fetchTrendi');
//     const data = await response.json();
//     const starRatingContainer = document.getElementById('starRating');
//     starRatingContainer.innerHTML = getFiveStar(data.star);
//   } catch (error) {
