var t="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},e={},o={},a=t.parcelRequired7c6;null==a&&((a=function(t){if(t in e)return e[t].exports;if(t in o){var a=o[t];delete o[t];var r={id:t,exports:{}};return e[t]=r,a.call(r.exports,r,r.exports),r.exports}var l=Error("Cannot find module '"+t+"'");throw l.code="MODULE_NOT_FOUND",l}).register=function(t,e){o[t]=e},t.parcelRequired7c6=a),a("faBfA"),a("h5Hr7"),a("bUb57"),a("eEHR3");var r=a("9MaFa"),l=a("7274P");function n(t){let e=Math.round(t);return[,,,,,].fill(0).map((t,o)=>e-2*(o+1)>=0?'<div class="star"></div>':e-2*(o+1)+1==0?'<div class="star-half"></div>':'<div class="star-outline"></div>').join("")}const s=new r.default,i=document.querySelector(".weekly-gallery");i.addEventListener("click",function(t){console.log(t.target.getAttribute("film-id"),"Це id фільму")}),s.fetchTrendingWeekMovies().then(t=>{let e=t.data.results;console.log(e);let o=function(t){let e=[];for(;e.length<3;){let o=Math.floor(Math.random()*t);e.includes(o)||(e.push(o),console.log(e))}return e}(e.length-1),a=[];o.forEach(t=>{let o=e[t];a.push(o)}),i.innerHTML=a.map(t=>(0,l.default)(t,n)).join(""),console.log(a)}).catch(t=>console.error(t));var r=a("9MaFa"),c=a("2rpgd");a("dvWtG");const d=(t,e)=>{try{let o=JSON.stringify(e);localStorage.setItem(t,o)}catch(e){console.error(`Error saving ${t} to localStorage:`,e)}},p=t=>{try{let e=localStorage.getItem(t);return e?JSON.parse(e):void 0}catch(e){console.error(`Error loading ${t} from localStorage:`,e);return}},g=document.querySelector(".js-upcoming-wrapper"),u=new r.default;console.log(u),u.fetchUpcomingMovies().then(t=>{console.log("Upcoming",t);let e=t.data;console.log(e);let o={pageCurrent:e.page,totalResults:e.total_results,results:e.results};console.log(o);let a=o.results;if(a.length>0){(function(t){let e=Math.floor(15*Math.random()),o=t.filter(t=>null!==t.backdrop_path).map(t=>`
