!function(){var t="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},e={},a={},r=t.parcelRequired7c6;null==r&&((r=function(t){if(t in e)return e[t].exports;if(t in a){var r=a[t];delete a[t];var o={id:t,exports:{}};return e[t]=o,r.call(o.exports,o,o.exports),o.exports}var i=Error("Cannot find module '"+t+"'");throw i.code="MODULE_NOT_FOUND",i}).register=function(t,e){a[t]=e},t.parcelRequired7c6=r),r("8ERGB"),r("3qT3v"),r("i8Q71"),r("kFyhi");var o=r("kK94C"),i=r("b3pWk"),n=r("jMVtP");r("ijwS8");var l=r("cbbxM");let s=new o.default,d=document.querySelector(".weekly-gallery");d.addEventListener("click",function(t){let e=t.target.closest("[film-id]");e&&(0,l.openModalCard)(e.getAttribute("film-id"))}),s.fetchTrendingWeekMovies().then(t=>{let e=t.data.results,a=function(t){let e=[];for(;e.length<3;){let a=Math.floor(Math.random()*t);e.includes(a)||e.push(a)}return e}(e.length-1),r=[];a.forEach(t=>{let a=e[t];r.push(a)}),d.innerHTML=r.map(t=>(0,i.default)(t,n.default)).join("")}).catch(t=>console.error(t));var o=r("kK94C"),p=r("lwvvG"),c=r("4LMMA");let u=document.querySelector(".js-upcoming-wrapper"),m=new o.default;m.fetchUpcomingMovies().then(t=>{let e=t.data,a={pageCurrent:e.page,totalResults:e.total_results,results:e.results},r=a.results;r.length>0?(function(t){let e=t.filter(t=>null!==t.backdrop_path).map(t=>{let e=`
    ...
    `;return{id:t.id,markup:e}})[Math.floor(15*Math.random())],{id:a,markup:r}=e;u.innerHTML=r;let o=document.querySelector(".up-btn");(0,c.isInLibrary)(a)?o.textContent="Remove from my library":o.textContent="Add to my library"}(r),u.addEventListener("click",t=>{if(t.target===document.querySelector(".up-btn")){let e=t.target,a=t.target.dataset.movieId,o=r.find(t=>t.id==a);(0,c.isInLibrary)(a)?((0,c.removeFromLibrary)(a),e.textContent="Add to my library"):((0,c.saveToLibrary)(o),e.textContent="Remove from my library")}})):0===r.length&&(u.innerHTML='<p class="upcoming-error">OOPS... We are very sorry! Upcoming this month not found.</p>')}).catch(t=>console.error(t)),r("cbbxM"),r("ijwS8"),r("guHir"),r("7hKzD")}();
//# sourceMappingURL=index.40a84b2d.js.map
