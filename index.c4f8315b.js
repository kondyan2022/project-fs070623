    ...
    <div class="upcoming-right-wrap">
        ...
        <table class="upcoming-table">
            ...
            <tr class="upcoming-tab-row">
                ...
                <td class="upcoming-data-get">${(0,i.default)().filter(({id:e})=>t.genre_ids.includes(e)).map(({name:t})=>t).slice(0,2).join(", ")}</td>
            </tr>
        </table>
...
//# sourceMappingURL=index.c4f8315b.js.map
