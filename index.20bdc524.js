!function(){var t="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},e={},a={},r=t.parcelRequired7c6;null==r&&((r=function(t){if(t in e)return e[t].exports;if(t in a){var r=a[t];delete a[t];var o={id:t,exports:{}};return e[t]=o,r.call(o.exports,o,o.exports),o.exports}var i=Error("Cannot find module '"+t+"'");throw i.code="MODULE_NOT_FOUND",i}).register=function(t,e){a[t]=e},t.parcelRequired7c6=r),r("8ERGB"),r("3qT3v"),r("i8Q71");var o=r("kK94C"),i=r("ijwS8"),n=r("jMVtP"),s=r("cbbxM");document.querySelector(".js-newhero-open-modal-tr");let l=document.querySelector(".newhero-render-wrapper"),d=new o.default;d.fetchTrendingDayMovies().then(t=>{let e=t.data,a={pageCurrent:e.page,totalResults:e.total_results,results:e.results},r=a.results;if(r.length>0){(function(t){let e=t.filter(t=>null!==t.backdrop_path).map(t=>{let e=`
    ...
    `;return{markup:e}})[Math.floor(15*Math.random())],{markup:a}=e;setTimeout(()=>{l.innerHTML=a,(0,i.modalController)({modal:".modal1",btnOpen:".js-newhero-open-modal-tr",btnClose:".modal__close"})},3e3)})(r);return}}).catch(t=>console.error(t)),l.addEventListener("click",function(t){if(t.target===document.querySelector(".js-newhero-open-mod-det")){let e=t.target.closest("[film-id]");e&&(0,s.openModalCard)(e.getAttribute("film-id"))}});var o=r("kK94C"),p=r("b3pWk"),n=r("jMVtP");r("ijwS8");var s=r("cbbxM");let c=new o.default,u=document.querySelector(".weekly-gallery");u.addEventListener("click",function(t){let e=t.target.closest("[film-id]");e&&(0,s.openModalCard)(e.getAttribute("film-id"))}),c.fetchTrendingWeekMovies().then(t=>{let e=t.data.results,a=function(t){let e=[];for(;e.length<3;){let a=Math.floor(Math.random()*t);e.includes(a)||e.push(a)}return e}(e.length-1),r=[];a.forEach(t=>{let a=e[t];r.push(a)}),u.innerHTML=r.map(t=>(0,p.default)(t,n.default)).join("")}).catch(t=>console.error(t));var o=r("kK94C"),m=r("lwvvG"),h=r("4LMMA");let g=document.querySelector(".js-upcoming-wrapper"),w=new o.default;w.fetchUpcomingMovies().then(t=>{let e=t.data,a={pageCurrent:e.page,totalResults:e.total_results,results:e.results},r=a.results;r.length>0?(function(t){let e=t.filter(t=>null!==t.backdrop_path).map(t=>{let e=`
...
//# sourceMappingURL=index.20bdc524.js.map
