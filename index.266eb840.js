!function(){var t="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},e={},a={},r=t.parcelRequired7c6;null==r&&((r=function(t){if(t in e)return e[t].exports;if(t in a){var r=a[t];delete a[t];var o={id:t,exports:{}};return e[t]=o,r.call(o.exports,o,o.exports),o.exports}var l=Error("Cannot find module '"+t+"'");throw l.code="MODULE_NOT_FOUND",l}).register=function(t,e){a[t]=e},t.parcelRequired7c6=r),r("8ERGB"),r("3qT3v"),r("i8Q71"),r("gVa74");var o=r("kK94C"),l=r("b3pWk");function i(t){let e=Math.round(t);return[,,,,,].fill(0).map((t,a)=>e-2*(a+1)>=0?'<div class="star"></div>':e-2*(a+1)+1==0?'<div class="star-half"></div>':'<div class="star-outline"></div>').join("")}let n=new o.default,s=document.querySelector(".weekly-gallery");s.addEventListener("click",function(t){let e=t.target.closest("[film-id]");e&&console.log(e.getAttribute("film-id"))}),n.fetchTrendingWeekMovies().then(t=>{let e=t.data.results,a=function(t){let e=[];for(;e.length<3;){let a=Math.floor(Math.random()*t);e.includes(a)||e.push(a)}return e}(e.length-1),r=[];a.forEach(t=>{let a=e[t];r.push(a)}),s.innerHTML=r.map(t=>(0,l.default)(t,i)).join("")}).catch(t=>console.error(t));var o=r("kK94C"),d=r("lwvvG");let c=(t,e)=>{try{let a=JSON.stringify(e);localStorage.setItem(t,a)}catch(e){console.error(`Error saving ${t} to localStorage:`,e)}},p=t=>{try{let e=localStorage.getItem(t);return e?JSON.parse(e):void 0}catch(e){console.error(`Error loading ${t} from localStorage:`,e);return}};function u(t){let e=p("moviesData")||[];return 1===e.filter(({id:e})=>e==t).length}let g=document.querySelector(".js-upcoming-wrapper"),m=new o.default;m.fetchUpcomingMovies().then(t=>{let e=t.data,a={pageCurrent:e.page,totalResults:e.total_results,results:e.results},r=a.results;r.length>0?(function(t){let e=t.filter(t=>null!==t.backdrop_path).map(t=>{let e=`
...
//# sourceMappingURL=index.266eb840.js.map
